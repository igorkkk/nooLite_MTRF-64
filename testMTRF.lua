-- Это для тестирования и настройки
-- непосредственно в устройство файл не входит!!!

do
sendRAW = {}
-- много примеров sendRAW смотрите https://igorkandaurov.com/2017/04/20/noolite-f-mtrf-64-slf-1-300-%d1%87%d0%b0%d1%81%d1%82%d1%8c-2/
